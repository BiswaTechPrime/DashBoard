...
<nav class="navbar navbar-default navbar-static-top">
 ...
 <c:forEach items="${listuser}" var="user">
  ...
  <div><center>  <h2> Welcome ${user.name} </h2></center></div>
    ...
    <div style="color: Green"><center>  <h2>  ${changephone} </h2></center></div>
  <div style="color: Green"><center>  <h2>  ${changePassword} </h2></center></div>
</div>
