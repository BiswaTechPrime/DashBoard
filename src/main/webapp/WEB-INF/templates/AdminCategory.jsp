...
<head>
 ...
 <!--    <link rel="shortcut icon" href="resources/themescp/assets/images/favicon.png" type="image/png"> -->
  ...
  <!--   <link href="/abcp/resources/themescp/assets/css/style.default.css" rel="stylesheet">
    <link href="/abcp/resources/themescp/assets/css/jquery.datatables.css" rel="stylesheet"> -->
...
<br>
    ...
    <!-- <script src="AdminCategory/jquery-1.11.1.min.js"></script>
    <script src="/abcp/resources/themescp/assets/js/jquery-migrate-1.2.1.min.js"></script>
    <script src="/abcp/resources/themescp/assets/js/bootstrap.min.js"></script>
    <script src="/abcp/resources/themescp/assets/js/modernizr.min.js"></script>
    <script src="/abcp/resources/themescp/assets/js/jquery.sparkline.min.js"></script>
    <script src="/abcp/resources/themescp/assets/js/toggles.min.js"></script>
    <script src="/abcp/resources/themescp/assets/js/retina.min.js"></script>
    <script src="/abcp/resources/themescp/assets/js/jquery.cookies.js"></script>

    <script src="/abcp/resources/themescp/assets/js/select2.min.js"></script>
    <script src="/abcp/resources/themescp/assets/js/jquery.validate.min.js"></script>
    <script src="/abcp/resources/themescp/assets/js/custom.js"></script>
    <script src="/abcp/resources/themescp/assets/js/jquery.datatables.min.js"></script> -->
