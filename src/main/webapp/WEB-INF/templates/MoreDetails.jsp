...
<div id='carousel-custom' class='carousel slide' data-ride='carousel'>
    <div class='carousel-outer'>
        ...
        <div class='carousel-inner'>
            ...
            <div class='item active'>
             <c:forEach items="${listImage}" var="product">
             <!--    <img src='http://cdn2.gsmarena.com/vv/bigpic/apple-iphone-4-ofic-final.jpg' alt=''id="zoom_05"  data-zoom-image="http://cdn2.gsmarena.com/vv/bigpic/apple-iphone-4-ofic-final.jpg"/> -->
             <img src="<%=application.getContextPath()%>/resources/images/${product.name}" alt="a"  id="zoom_05" data-zoom-image="<%=application.getContextPath()%>/resources/images/${product.name}" />
              </c:forEach>
            </div>
            <!-- <div class='item'  id="zoom_05">
                <img src='http://cdn2.gsmarena.com/vv/bigpic/apple-iphone-6-plus2.jpg' alt='' data-zoom-image="http://cdn2.gsmarena.com/vv/bigpic/apple-iphone-6-plus2.jpg" />
            </div>
            <div class='item'>
                <img src='http://s.tmocache.com/content/dam/tmo/en-p/cell-phones/apple-iphone-6s/space-gray/stills/carousel-apple-iphone-6s-space-gray-380x380-1.jpg' alt='' data-zoom-image="http://s.tmocache.com/content/dam/tmo/en-p/cell-phones/apple-iphone-6s/space-gray/stills/carousel-apple-iphone-6s-space-gray-380x380-1.jpg" />
            </div>
                
            <div class='item'>
                <img src='http://i-cdn.phonearena.com/images/phones/48955-xlarge/Apple-iPhone-6-0.jpg' alt='' data-zoom-image="http://i-cdn.phonearena.com/images/phones/48955-xlarge/Apple-iPhone-6-0.jpg" id="zoom_05"/>
            </div>
            <div class='item'>
                <img src='http://www.extremetech.com/wp-content/uploads/2013/09/iph.jpg' alt='' data-zoom-image="http://www.extremetech.com/wp-content/uploads/2013/09/iph.jpg" id="zoom_05"/>
            </div>
            <div class='item'>
                <img src='http://www.telegraph.co.uk/content/dam/technology/2016/03/09/3iphone6s_3448296b-large_trans++pJliwavx4coWFCaEkEsb3kvxIt-lGGWCWqwLa_RXJU8.jpg' alt='' data-zoom-image="http://www.telegraph.co.uk/content/dam/technology/2016/03/09/3iphone6s_3448296b-large_trans++pJliwavx4coWFCaEkEsb3kvxIt-lGGWCWqwLa_RXJU8.jpg" id="zoom_05"/>
            </div>
            <div class='item'>
                <img src='http://www.concept-phones.com/wp-content/uploads/2012/01/iPhone_SJ_concept_1.jpg' alt='' data-zoom-image="http://www.concept-phones.com/wp-content/uploads/2012/01/iPhone_SJ_concept_1.jpg" id="zoom_05"/>
            </div> -->
            <script>
   $("#zoom_05").elevateZoom({ zoomType    : "inner", cursor: "crosshair" });
    ...
    <ol class='carousel-indicators mCustomScrollbar meartlab'>
       <c:forEach items="${listImage}" var="product">
       <!--  <li data-target='#carousel-custom' data-slide-to='0' class='active'><a class="pan"><img src='http://cdn2.gsmarena.com/vv/bigpic/apple-iphone-4-ofic-final.jpg' alt='' /></a></li>
        <li data-target='#carousel-custom' data-slide-to='1'><img src='http://cdn2.gsmarena.com/vv/bigpic/apple-iphone-6-plus2.jpg' alt='' /></li>
        <li data-target='#carousel-custom' data-slide-to='2'><img src='http://s.tmocache.com/content/dam/tmo/en-p/cell-phones/apple-iphone-6s/space-gray/stills/carousel-apple-iphone-6s-space-gray-380x380-1.jpg' alt='' /></li>
        <li data-target='#carousel-custom' data-slide-to='3'><img src='http://i-cdn.phonearena.com/images/phones/48955-xlarge/Apple-iPhone-6-0.jpg' alt='' /></li>
        <li data-target='#carousel-custom' data-slide-to='4'><img src='http://www.extremetech.com/wp-content/uploads/2013/09/iph.jpg' alt='' /></li>
        <li data-target='#carousel-custom' data-slide-to='5'><img src='http://www.telegraph.co.uk/content/dam/technology/2016/03/09/3iphone6s_3448296b-large_trans++pJliwavx4coWFCaEkEsb3kvxIt-lGGWCWqwLa_RXJU8.jpg' alt='' /></li> -->
        <li data-target='#carousel-custom' data-slide-to='5'> <img src="<%=application.getContextPath()%>/resources/images/${product.name}" alt="a" /></li>
</c:forEach>
    </ol>
