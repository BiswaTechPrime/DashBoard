...
<nav class="navbar navbar-default navbar-static-top">
				...
				<li class="dropdown ">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="divider"></li>
							<li><a href="/cw/logout">Logout</a></li>
						</ul>
					</li>
				</ul>
			</div><!-- /.navbar-collapse -->
	...
	<center><h1>Change Phone Number</h1></center>
		...
		<form:form action="/cw/changePhone" modelAttribute="myprofile" method="post">   <!--   going to the MappingController -->
<div class="container" style="padding-top: 50px">

 <div class="form-group" style="padding-left: 400px;font-size: 20px">
         Enter old Phone Number
         <br>
    		<input id="phone" name="oldphone" type="text" class="form-control" style="width: 50%" placeholder="Enter old Phone Number" required>
		</div>
		 <div class="form-group" style="padding-left: 400px;font-size: 20px">
		 Enter new Phone Number
		 <br>
    		<input id="phone" name="newphone" type="text" class="form-control"  style="width: 50%" placeholder="Enter new Phone Number" required>
		</div>
		
		 <div class="form-group" style="padding-left: 400px;font-size: 20px">
		
		 <br>
    		<input id="Email1" name="email" type="hidden" value="${email}" class="form-control"  style="width: 50%" placeholder="Enter password" required>
		</div>
