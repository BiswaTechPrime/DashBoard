...
<div class="container" style="padding-top: 50px">
 ...
 <div class="form-group" style="padding-left: 400px;font-size: 20px">
         ...
         <br>
    		<input id="phone" name="phone" type="text" class="form-control" style="width: 50%" placeholder="Enter old Phone Number" required>
		</div>
		 <div class="form-group" style="padding-left: 400px;font-size: 20px">
		 Enter new Phone Number
		 <br>
    		<input id="phone" name="phone" type="text" class="form-control"  style="width: 50%" placeholder="Enter new Phone Number" required>
		</div>
