...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
   <link href="resources/AdminPage/css/AdminPage.css" rel="stylesheet">
      ...
      <link href="resources/NewAdminPage/css/NewAdminPage.css" rel="stylesheet">
...
<div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>
            <a href="#" class="btn btn-sq-lg btn-primary btn btn-space">
                <i class="fa fa-tachometer fa-5x"></i><br/>
               Dashboard 
            </a>
           <!--  <a href="#" class="btn btn-sq-lg btn-success btn btn-space">
              <i class="fa fa-users fa-5x"></i><br/>
             Registered Users 
            </a> -->
            <a href="<c:url value="admincategory"/>" class="btn btn-sq-lg btn-info btn btn-space">
              <i class="fa fa-email fa-5x"></i><br/>
              Categories 
            </a>
            <a href="<c:url value="adminsubcategory"/>" class="btn btn-sq-lg btn-warning btn btn-space">
              <i class="fa fa-home fa-5x"></i><br/>
             Sub-Category
            </a>
            <a href="<c:url value="adminitem"/>" class="btn btn-sq-lg btn-primary btn btn-space">
...
<br><br><br><br>
    ...
    <!--/.footer-bottom--> 
		 ...
		 <script src="resources/AdminPage/js/AdminPage.js"></script>
		 		 ...
		 		 <script src="resources/NewAdminPage/js/NewAdminPage.js"></script>
