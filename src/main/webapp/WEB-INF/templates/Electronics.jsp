	...
	<div class="side-menu">
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
              ...
              <li class="active"><a href="<c:url value="electronics"/>"> Electronics</a></li>
              <li><a href="<c:url value="furnitures"/>" >Furniture</a></li>
              <li><a href="<c:url value="fashion"/>" >Fashion</a></li>
                             <li><a href="<c:url value="fashio"/>" >Others</a></li>
		...
		<div class="container" style="width: 100% ; padding-bottom: 300px">
		
		<!--loop-->
            <div class="panel panel-default">
                <div class="panel-body">
                     <div class="col-xs-6 col-sm-3 placeholder text-center">
             <a href="<c:url value="mobile"/>">  <img src="http://img.weiku.com/a/2011/11/8/7/4G_TV_mobile_phone_F080_8155_3.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Mobile Phones</h4>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder text-center">
             <a href="<c:url value="tab"/>">  <img src="http://www.innovativesys.com/wp-content/uploads/2014/12/byod.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Tablets</h4>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder text-center">
              <a href="<c:url value="computer"/>"> <img src="http://www.cre8vecon10t.com/wp-content/uploads/2014/02/Handshake-Laptops-600x450.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Computers</h4>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder text-center">
             <a href="<c:url value="tv"/>">  <img src="https://pbs.twimg.com/media/CCn-vgWUkAA_EG9.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Televisions</h4>
            </div>
            <br/>
             <div class="col-xs-6 col-sm-3 placeholder text-center">
             <a href="<c:url value="ac"/>">  <img src="http://imageshotfrogin.blob.core.windows.net/companies/Used-Second-Hand-Ac-Airconditioner-Refrigerator-Washing-Machine-Computers-Furniture-etc-Ups-Inverters-Buyers-In-Bangalore/images/Used-Second-Hand-Ac-Airconditioner-Refrigerator-Washing-Machine-Computers-Furniture-etc-Ups-Inverters-Buyers-In-Bangalore_132573_image.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Fridge-A.C.-Washing Machine</h4>
            </div>
             <div class="col-xs-6 col-sm-3 placeholder text-center">
             <a href="<c:url value="kitchen"/>">  <img src="https://tuffclassified.com/oc-content/uploads/8124/766087.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
