	...
	<div class="side-menu">
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
              ...
              <li class="active"><a href="<c:url value="fashion"/>" >Fashion</a></li>
		...
		<!--loop-->
            <div class="panel panel-default">
             ...
             <a href="<c:url value="clothes"/>">  <img src="http://sc01.alicdn.com/kf/HTB1M..HGXXXXXcOXpXXq6xXFXXXK/206103066/HTB1M..HGXXXXXcOXpXXq6xXFXXXK.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Clothes</h4>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder text-center">
             <a href="<c:url value="foot"/>">  <img src="http://www.libertyshoes.com/Uploads/SmallImages/73news_jaamnagar.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Footwear</h4>
            </div>
          </div>
                </div>
