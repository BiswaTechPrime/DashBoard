...
<div class="container-fluid">
      ...
      <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-md-2 sidebar" style="padding-top: 50px ; border: 1px black">
  			<div class="row">
		...
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
				<ul class="nav navbar-nav">
					<li><a href="#"><span class="glyphicon glyphicon-dashboard"></span> Vehicles</a></li>
					<li  class="active"><a href="#"><span class="glyphicon glyphicon-plane"></span> Electronics</a></li>
					<li><a href="#"><span class="glyphicon glyphicon-cloud"></span> Furniture</a></li>

					

					<li><a href="#"><span class="glyphicon glyphicon-signal"></span> Fashion</a></li>
