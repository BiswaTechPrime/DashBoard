...
/*  alert("asdsa") ;  */
   ...
   <link href="resources/NewFile1/css/NewFile1.css" rel="stylesheet">
      ...
      <link href="resources/largebuttons/lg1.css" rel="stylesheet">
       <!-- <link href="resources/largebuttons/lg2.css" rel="stylesheet"> -->
        <link href="resources/largebuttons/lg3.css" rel="stylesheet">
    	...
    	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
			    <div class="item active">
			    	<img src="https://couponslite.com/wp-content/uploads/2016/04/slide-3.jpg" alt="First slide">
                    <!-- Static Header -->
                    <div class="header-text hidden-xs">
                       <!--  <div class="col-md-12 text-center">
                            <h2>
                            	<span>Welcome to <strong>BECH DO!!</strong></span>
                            </h2>
                            <br>
                            <h3>
                            	<span>Buy and sell everything!</span>
                            </h3>
                            <br>
                           </div> -->
                    </div><!-- /header-text -->
			    ...
			    <div class="item">
			    	<img src="http://www.galco.com/images/homepage/home-banner-slider1-md.jpg" alt="Second slide">
			    	<!-- Static Header -->
                    <div class="header-text hidden-xs">
                       <!--  <div class="col-md-12 text-center">
                            <h2>
                                <span>Welcome to BECH DO!!</span>
                            </h2>
                            <br>
                            <h3>
                            	<span>Wide range of bikes</span>
                            </h3>
                            <br>
			    ...
			    <div class="item">
			    	<img src="http://paragontechweb.com/wp-content/uploads/2016/05/Slide1.png" alt="Third slide">
			    	<!-- Static Header -->
                    <div class="header-text hidden-xs">
                      <!--   <div class="col-md-12 text-center">
                            <h2>
			...
			<!-- Controls -->
			<!-- <a class="left carousel-control pull-right"  href="#carousel-example-generic" data-slide="prev">
		    	<span class="glyphicon glyphicon-chevron-left" style="padding-top: 50px" ></span>
			</a>
			<a class="right carousel-control pull-left" href="#carousel-example-generic" data-slide="next">
...
<div class="main">
	...
	<div class="view second-effect">
		<img src="https://wallpaperscraft.com/image/porsche_cars_city_sunset_83884_1920x1080.jpg" class="img-responsive" />
        <div class="mask">
			<a href="<c:url value="cars"/>"><h3>Vehicles</h3></a>
		</div>
	</div>

	<div class="view second-effect">
		<img src="https://wallpaperscraft.com/image/living_room_sofa_furniture_style_75503_1920x1080.jpg" class="img-responsive"/>
		<div class="mask">
			<a href="<c:url value="bike"/>"><h3>Electronics</h3></a>
		</div>
	</div>	

	<div class="view second-effect">
		<img src="https://wallpaperscraft.com/image/sony_mobile_xperia_zr_colour_phones_92306_1920x1080.jpg" class="img-responsive"/>
		<div class="mask">
			<a href="<c:url value="fur"/>"><h3>Furniture</h3></a>
		</div>
	</div>

	<div class="view second-effect">
		<img src="https://fitness-static.reebok.com/cdn-1d082c2391159e5/PageFiles/701104/reebok_mothers_day_gift_guide_product_laydown.jpg" class="img-responsive" />
		<div class="mask">
			<a href="<c:url value="fashio"/>" ><h3>Fashion</h3></a>
		</div>
	</div>
	<div class="view second-effect">
		<img src="http://www.wallpaperhi.com/thumbnails/detail/20120712/animals%20dogs%201920x1080%20wallpaper_www.wallpaperhi.com_6.jpg" class="img-responsive" />
		<div class="mask">
			<a href="<c:url value="pets"/>" ><h3>Pets</h3></a>
		</div>
	</div>
	<div class="view second-effect">
		<img src="https://i.ytimg.com/vi/CWM33BgKzvM/maxresdefault.jpg" class="img-responsive" />
		<div class="mask">
			<a href="<c:url value="Others"/>" ><h3>Others</h3></a>
		</div>
	</div>
                        ...
                        <div class="col-sm-3">
                             ...
                             <div class="col-item">
                                ...
                                <div class="info">
                                        ...
                                        <p class="btn-details">
                                            <a href="<c:url value='/moredetails?id=${product.id}'  />" class="hidden-sm">More details</a>
                                        </p>
                        ...
                        <div class="col-sm-3">
                            <div class="col-item">
                                ...
                                <div class="info">
                                        ...
                                        <p class="btn-details">
                                            <a href="<c:url value='/moredetails?id=${car2.id}'  />" class="hidden-sm">More details</a>
                                        </p>
                        ...
                        <div class="col-sm-3">
                             ...
                             <div class="col-item">
                                ...
                                <div class="info">
                                        ...
                                        <p class="btn-details">
                                         <a href="<c:url value='/moredetails?id=${bike1.id}'  />" class="hidden-sm" >More details</a>
                                        </p>
                            ...
                            <div class="col-item">
                                ...
                                <div class="info">
                                    <div class="separator clear-left">
                                        ...
                                        <p class="btn-details">
                                          <a href="<c:url value='/moredetails?id=${bike2.id}'  />" class="hidden-sm">More details</a>
                                        </p>
                                    </div>
                                    <div class="clearfix">
                                    </div>
