...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
   <link href="resources/NewLoginadmin/css/NewLogin.css" rel="stylesheet">
...
<div class="row" style="margin-top:20px">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		     <form:form action="/cw/adminLogin" role="form" commandName="adminlogin" method="post" modelAttribute="adminlogin">        
		
			<fieldset>
				<h2>Admin Login</h2>
				
				 <div style= color:red>
                   ${param.msg}            <!-- coming from AdminLoginController -->
                   </div>
				...
				<div class="row">
					...
					<div class="col-xs-6 col-sm-6 col-md-6">
						<a href="<c:url value="adregister"/>" class="btn btn-lg btn-primary btn-block">Register</a>
					</div>
     ...
     <script src="resources/NewLoginadmin/js/NewLogin.js"></script>
