                    ...
                    <div class="contentpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
								...
								<form:form action="${addAction}" commandName="bank" id="form1" modelAttribute="bank">
													...
													<tbody>
														<c:forEach items="${listBank}" var="bank">
															<tr class="active">
																<td>${bank.id}</td>
																<td>${bank.name}</td>
																<td class="center"><a href="<c:url value='bank?id=${bank.id}' />"><i class="fa fa-edit "></i></a></td>
																<td class="center">
