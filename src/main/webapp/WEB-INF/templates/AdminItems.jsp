    ...
    <script type="text/javascript">
        ...
        xhttp.onreadystatechange = function() {
          if (xhttp.readyState == 4 && xhttp.status == 200) {
            document.getElementById("subc").innerHTML = xhttp.responseText;
          }
        };
                    ...
                    <div class="contentpanel" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
								...
								<form:form action="/cw/item/add" commandName="item" id="form1" modelAttribute="item">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <c:if test="${!empty item.name}">
						                ...
						                <div class="form-group">
                                            <label class="col-sm-3 control-label">
                                            <form:label path="categorys"><spring:message text="Category" /></form:label> 
                                            <span class="asterisk">*</span>
                                            </label>
                                            <div class="col-sm-9">
                                            <spring:bind path="categorys.id">
												<form:select path="categorys.id" class="select2" style="width:100%;" onchange="showSubcategory(this.value)">
                                        ...
                                        <div class="form-group" >
                                            <label class="col-sm-3 control-label">
                                            <form:label path="subCategory"><spring:message text="Select Sub_Categories" /></form:label> 
                                            <span class="asterisk">*</span>
                                            </label>
                                            <div class="col-sm-9" id="subc">
                                           <%--  <spring:bind path="customers.name"> --%>
                                         ...
                                         <div class="form-group" >
                                            <label class="col-sm-3 control-label">
                                            <form:label path="subCategory"><spring:message text="Subcategory" /></form:label> 
                                            <span class="asterisk">*</span>
                                            </label>
                                            <div class="col-sm-9" id="slct">
                                            <spring:bind path="subCategory">
												<form:select path="subCategory.id" class="select2" style="width:100%;">
													<form:option value="0">Select</form:option>
													 <form:options items="${Subcategory}" itemValue="id" itemLabel="itemname"/> 
										...
										<div class="table-responsive">
											<c:if test="${!empty listitem}">
												<table class="table table-striped table-bordered table-hover" id="table2">
													<thead>
														<tr class="info">
														   <!--  <th width="80">Select to Delete</th> -->
															<th width="80">ID</th>
															<th width="80">Category</th>
															<th width="80">SubCategory</th>
															<th width="80">SubCategory</th>
															<th width="60">Edit</th>
													...
													<tbody>
														<c:forEach items="${listitem}" var="item">
															<tr class="active">
																<%-- <td><input id="checkbox" name="cc" type="checkbox" value="${item.id}" /></td> --%>
																<td>${item.id}</td>
																<td>${item.categorys.name}</td>
																<td>${item.subCategory.itemname}</td>
																<td>${item.name}</td>
																<td class="center"><a href="<c:url value='item?id=${item.id}' />"><i class="fa fa-edit "></i></a></td>
																<td class="center">
																<a href="<c:url value='/item/delete/${item.id}' />"><i class="fa fa-trash-o"></i></a></td>
															</tr>
														</c:forEach>
		
													</tbody>
												</table>
												<!-- <input type="button" value="Press to delete selected items" id="btnDelete" onclick="del()" /> -->
											</c:if>
										</div>
