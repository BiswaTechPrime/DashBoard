...
<nav class="navbar navbar-default navbar-static-top">
	...
	<form:form action="/cw/changePassword" modelAttribute="myprofile" method="post">
<div class="container" style="padding-top: 50px">

 <div class="form-group" style="padding-left: 400px;font-size: 20px">
         Enter old password
         <br>
    		<input id="Email1" name="old" type="password" class="form-control" style="width: 50%" placeholder="Enter Old password" required>
		</div>
		 <div class="form-group" style="padding-left: 400px;font-size: 20px">
		 Enter new password
		 <br>
    		<input id="Email1" name="newp" type="password" class="form-control"  style="width: 50%" placeholder="Enter password" required>
		</div>
		 <div class="form-group" style="padding-left: 400px;font-size: 20px">
