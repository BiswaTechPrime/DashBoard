	...
	<div class="side-menu">
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
              ...
              <li class="active"><a href="<c:url value="furnitures"/>" >Furniture</a></li>
		...
		<!--loop-->
            <div class="panel panel-default">
             ...
             <a href="<c:url value="sofa"/>">  <img src="http://for-sale.used-secondhand.co.uk/media/used/secondhand/images/32141/6x-brand-new-sabrina-corner-sofa-set-dining-and-lounge-sets-peterborough/600/6x-brand-new-sabrina-corner-sofa-set-dining-and-lounge-sets-722.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Sofa & Dining</h4>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder text-center">
             <a href="<c:url value="beds"/>">  <img src="http://www.luxus-india.com/wp-content/uploads/2016/02/Trundle-Bed.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Beds & Wardrobes</h4>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder text-center">
              <a href="<c:url value="home"/>"> <img src="http://cdn.home-designing.com/wp-content/uploads/2016/02/creative-dining-room-decor-600x450.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Home Decor & Garden</h4>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder text-center">
             <a href="<c:url value="other"/>">  <img src="http://img.diytrade.com/cdimg/868645/9695729/0/1247299664/Mountain_bicycle_full_suspension.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Others</h4>
            </div>
          </div>
                </div>
