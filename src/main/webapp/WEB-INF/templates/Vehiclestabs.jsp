		...
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="side-menu-container">
				<ul class="nav navbar-nav">
					 <li class="active"><a href="<c:url value="Vehicles"/>">Vehicles</a></li>
		...
		<!--loop-->
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-xs-3 col-sm-3 placeholder text-center">
             <a href="<c:url value="car"/>">  <img src="http://4.bp.blogspot.com/_pIfFF1ij3Vw/TMiY3y42zyI/AAAAAAAABmI/U27xuesFGIA/s1600/The+New+Cars.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Cars</h4>
            </div>
            <div class="col-xs-3 col-sm-3 placeholder text-center">
             <a href="<c:url value="commercial"/>">  <img src="http://assets-cdn.ekantipur.com/images/the-kathmandu-post-archive/ped/2015/20150202competition-in-commercial-vehicle-segment-heats-up-600x0.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Commercial Vehicles</h4>
            </div>
            <div class="col-xs-3 col-sm-3 placeholder text-center">
              <a href="<c:url value="motor"/>"> <img src="http://www.mod-sales.com/images/additional/group%20bikes%20002.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Motorcycles</h4>
            </div>
           
            <div class="col-xs-3 col-sm-3 placeholder text-center">
             <a href="<c:url value="cycle"/>">  <img src="http://img.diytrade.com/cdimg/868645/9695729/0/1247299664/Mountain_bicycle_full_suspension.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Bi-cycles</h4>
            </div>
            <br>
             <div class="col-xs-6 col-sm-3 placeholder text-center">
             <a href="<c:url value="spare"/>">  <img src="http://www.wheeledtractor.com/uploads/walking-tractor/garden-tiller-spare-parts.jpg" class="center-block img-responsive img-circle" alt="Generic placeholder thumbnail"></a>
              <h4>spare parts</h4>
            </div>
          </div>
                </div>
